...
public class ConfigLdapCriteria implements Serializable, Criteria {
    ...
    public ConfigLdapCriteria() {
    }

    public ConfigLdapCriteria(ConfigLdapCriteria other) {
    ...
    @Override
    public ConfigLdapCriteria copy() {
        return new ConfigLdapCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ConfigLdapCriteria that = (ConfigLdapCriteria) o;
        return
