...
import {profilAdministareur, profilAgent, profilClient,profilControlleur,profilDirectionAchat,profilDemandeur,profilFinancier} from './menu';
@Injectable()
export class MenuService {
  ...
  public getProfilAdministareur():Array<Menu>{
    return profilAdministareur;
  }

  public getProfilAgent():Array<Menu>{
    return profilAgent;
  }

  public getProfilClient():Array<Menu>{
    return profilClient;
  }

    public getProfilDemandeur():Array<Menu>{
        return profilDemandeur;
    }

    public getProfilDirectionAchat():Array<Menu>{
        return profilDirectionAchat;
    }

    public getProfilFinancier():Array<Menu>{
        return profilFinancier;
    }

    public getProfilControlleur():Array<Menu>{
        return profilControlleur;
    }
